...
public class BBRiceDhal {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		driver.findElementByXPath("(//a[text()='Ponni Boiled Rice - Super Premium']/following::div[@class='btn-group btn-input clearfix ng-scope'])[1]")
				.click();
		driver.findElementByXPath("(//a[text()='Ponni Boiled Rice - Super Premium']/following::span[contains(text(),'5 kg')])[1]")
				.click();

		// print the price of Rice
String ricePrice = driver
				.findElementByXPath("(//a[text()='Ponni Boiled Rice - Super Premium']/following::span[@class='discnt-price'])[1]")
				.getText();
